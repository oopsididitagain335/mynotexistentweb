  ...
  return (
    <Layout title="thebiolink.lol — Your Identity. Your Consequences." noNav>
      <div className="page-home min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <section className="flex flex-col items-center justify-center py-20 md:py-40">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4 max-w-md mx-auto">
            ...
            <button
              ...
              className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-full transition-all duration-300 transform hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Claim Now →
            </button>
          </form>
        ...
        {/* Feature Mockups */}
        <section className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          {/* Laptop Mockup */}
      ...
      <style jsx>{`
        .page-home {
          background-image: url('https://source.unsplash.com/random/1920x1080/?background');
...
export default Home;    window.addEventListener('mouseleave', handleMouseLeave);
